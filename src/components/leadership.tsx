        ...
        <motion.div variants={itemVariants} className="flex flex-col gap-6">
          ...
          <div className="space-y-4">
            <p className="font-bold">
              Kirsten leads Recursive&apos;s team operations, strategic advising, and product
              architecture.
            </p>
            <p className="text-muted-foreground">
              As an engineer and consultant, Kirsten has spent the past 8 years helping enterprises
              and technical teams launch and scale blockchain-based applications.
            </p>
            <p className="text-muted-foreground">
              She spent the past few years as CEO of a venture-backed protocol infrastructure for
              marketplaces, TalentLayer. Here she led a team of 20 in deploying and building an
              open-source ecosystem around their protocol. The protocol was highlighted in 2022 with
              a European Union Seal of Excellence and substantial grant for their work on
              marketplace data interoperability.
            </p>
            <p className="text-muted-foreground">
              Before TalentLayer, Kirsten spent 3 years as a consultant working on various
              enterprise blockchain products, including one of the biggest blockchain banking infra
              deployments in North America. During this time she also was co-chair of the Enterprise
              EOS Alliance, an enterprise blockchain industry group, and the IEEE&apos;s Blockchain
              Governance Working Group, a 200-member open-source standards organization. Kirsten has
              been featured as a speaker on blockchain infrastructure design by the European
              Commission, Fedex Institute, Consensys, and many others.
            </p>
            <p className="text-muted-foreground">
